...
public class TVShowadapetr extends RecyclerView.Adapter<TVShowadapetr.TVShowViewHolder> {

    public TVShowadapetr(List<TVShow> tvShows,TVShowListener tvShowListener) {
    ...
    @NonNull
    @Override
    public TVShowadapetr.TVShowViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TVShowadapetr.TVShowViewHolder holder, int position) {
